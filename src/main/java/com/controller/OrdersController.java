...
public class OrdersController {
    ...
    public R confirmReceipt(@RequestBody OrdersEntity orders, HttpServletRequest request){
        // 查询订单
        OrdersEntity order = ordersService.selectById(orders.getId());
        if(order == null) {
